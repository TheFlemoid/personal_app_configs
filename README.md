...
TMUX CONFIGURATION:
--------------------
1. To install the tmux configuration, run the tmuxSetup.sh script in the tmux folder.  The script will prevent you from running this as root.  I haven't made an uninstaller yet.
